...
export default function CriminalByDistrict() {
  ...
  const handleSearch = async (e) => {
    ...
    try {
      const response = await fetch(`/api/criminalbydistrict?district=${district}`);
    ...
    <>
      ...
      <div className="flex items-center justify-center min-h-screen">
        <div className="w-[40vw] bg-gray-100 p-6 rounded shadow-md">
          <h2 className="text-2xl font-bold mb-4">Search Criminals by District</h2>
